...
def download_and_split_CARS196(DATA_ROOT):
	...
	for i in tqdm(range(len(data2['annotations'][0]))):
		...
		if data2['annotations'][0][i][4][0][0]<=98:
			...
			f_train.write(str(data2['annotations'][0][i][4][0][0])+' '+os.path.join('cars_test',data2['annotations'][0][i][5][0])+'\r\n')
		else:
			f_test.write(str(data2['annotations'][0][i][4][0][0])+' '+os.path.join('bounding_test',data2['annotations'][0][i][5][0])+'\r\n')
			f_test.write(str(data2['annotations'][0][i][4][0][0])+' '+os.path.join('cars_test',data2['annotations'][0][i][5][0])+'\r\n')
	f_train.close()
	f_test.close()
